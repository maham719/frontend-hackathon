        ...
        >
          ...
          <form className="space-y-4" onSubmit={handleRegister}>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full rounded-xl border px-4 py-3 pr-11 text-base outline-none transition-colors placeholder:text-[#7f7a8c] ${
                    isDark
                      ? "border-[#4c3a5d] bg-[#2d2039] text-[#f2ebfa] placeholder:text-[#c7bdd9] focus:border-[#8d5fe5]"
                      : "border-[#ece1f8] bg-[#f7f2fb] text-[#1f1f2e] focus:border-[#a36ae8]"
                  }`}
            ...
            <label className="flex cursor-pointer items-center gap-3 pt-1">
              <input
                type="checkbox"
                className="h-4 w-4 rounded border-[#d6c6ee] accent-[#9b5ce7]"
              />
              <span
                className={`text-sm ${
