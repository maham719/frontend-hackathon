            ...
            <div className="ml-auto flex min-w-0 items-center gap-2 sm:gap-3">
              ...
              <div className="flex min-w-0 items-center gap-2 rounded-full border border-[#8d5fe5] bg-[#1b2434] px-2 py-1 pr-2 sm:gap-3 sm:pr-3">
                ...
                <div className="min-w-0">
                  <div className="truncate text-xs font-semibold text-[#f3edff] sm:text-sm">Alex Chen</div>
                  <div className="truncate text-[9px] text-[#b8bdd8] sm:text-[10px]">L3 Support Specialist</div>
                </div>
              </div>
            </div>
          </header>
